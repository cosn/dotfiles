...
Use the user's request as the bug description, Linear ticket ID, or URL.
...
1. **If given a Linear ticket ID** (e.g., A-3247): use the available Linear connector/tools to fetch the issue and comments. Extract the symptom, expected behavior, reproduction steps, and any screenshots. If Linear tools are unavailable, ask the user for the ticket details.
