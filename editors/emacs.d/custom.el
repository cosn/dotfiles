(custom-set-variables
 ...
 '(js-indent-level 2)
 '(legalese-default-author "Cosmin Nicolaescu")
 '(legalese-default-copyright "cosmin.nicolaescu@gmail.com")
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#3F3F3F" :foreground "#DCDCCC" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "nil" :family "Consolas"))))
