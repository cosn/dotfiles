...
alias gra="gh search prs --owner accrual-dev --author cosn --state open --draft=false --review approved --json number,title,url,repository -q '.[] | \"\(.repository.name)#\(.number)\t\(.title)\t\(.url)\"' | column -t -s \$'\t'"
...
alias pnbd="pnpm build --dual"
alias pnbr="pnpm build --remote"
alias pnd="pnpm dev"
alias pndd="pnpm dev --dual"
alias pndr="pnpm dev --remote"
alias pnr="pnpm run"
alias pni="pnpm install --recursive"
alias pnir="pnpm in --remote"
alias pnu="pnpm update --recursive"
alias pnur="pnpm update --recursive --remote"
alias pnx="pnpm nx"
alias nb="nx build"
alias nd="nx dev"
alias nt="nx test"
...
alias cf="claude --model claude-fable-5-1"
